...
- J/L cuts require suitable audio handles and a speech-aware timeline. Do not claim the cut-only playbook renderer supports them. Use documented editor controls/TSX and review the resulting audio.
